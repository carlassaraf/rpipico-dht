...
/**
 * @brief Inicializa los perifericos necesarios para usar el DHT
 * @param dht puntero a una instancia de DHT
 * @param model tipo de DHT usado (DHT11, DHT12, DHT21, DHT22)
 * @param data_pin numero de GPIO usado
 * @param pull_up habilitar pull-up interno o no
*/
...
/**
 * @brief Desinicializa los perifericos
 * @param dht puntero a la instancia de DHT a desinicializar
*/
...
/**
 * @brief Inicia una medicion con el DHT
 * @param dht puntero a la instancia de DHT a usar
*/
...
/**
 * @brief Espera a que termine la medicion y devuelve la humedad y temperatura
 * @param humidity puntero a variable donde guardar la humedad
 * @param temperature_c puntero a variable donde guardar la temperatura en celsius
*/
